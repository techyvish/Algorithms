...
public:
    ...
    int getNumber(string S)
    {
        ...
        F(i,0,S.length())
        {
            ...
            {
                string s = S.substr(0, i+1);
                totalUgliness = calculateUgliness(s);
            }
            
        }
        if ( totalUgliness == 999999 )
            return 0;
        else
            return totalUgliness;
